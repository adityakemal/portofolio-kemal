...
type ListToShow = {
  type: "imageList" | "iframe" | "video";
  imageList?: readonly string[];
  iframe?: string;
  video?: string;
};
...
export function ProjectCard({
  ...
  const listToShowType = listToShow?.type;
            ...
            preview={{
              mask: (
                <div className="flex items-center gap-x-1 text-sm">
                  Preview Project <ArrowRight size={14} />
                </div>
              ),
              destroyOnClose: true,
              ...
              imageRender: () => (
                <video
                  src={listToShow?.video}
                  className="w-full max-w-[1080px] object-contain aspect-video hover:object-contain"
                  autoPlay
                  // loop
                  muted
                  controls
